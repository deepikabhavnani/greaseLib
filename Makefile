...
CXXFLAGS= -fPIC -std=c++11 -fno-inline
...
# -luv -lTW -ltcmalloc_minimal
LDFLAGS += -L./deps/build/lib  -ldl -lm -lstacktrace -lstdc++ -lpthread -pthread
# -Wl,-whole-archive deps/build/lib/libtcmalloc_minimal.a -Wl,-no-whole-archive 
STATIC_LIB_FLAGS= -ldl -lTW -lm -Wl,-whole-archive
...
all: grease_echo libgrease.a-server libgrease.so.1 standalone_test_logsink
